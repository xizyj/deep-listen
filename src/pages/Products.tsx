...
const Products: React.FC = () => {
  ...
  // 初始化时就设置所有部分可见，确保内容能立即显示
  const isVisible: Record<string, boolean> = {
    'voice-lock': true,
    'voice-remote': true,
    'voice-fan': true,
    'voice-panel': true,
    'smart-microphone': true,
    'voice-agent': true,
    'support': true,
    'contact': true
  };
  ...
  return (
    <div className="products-page">
        ...
        <div className="container">
          ...
          {productCategories.map((category) => (
            <div 
              key={category.id} 
              id={category.id} 
              className={`product-category fade-in-section ${isVisible[category.id] || false ? 'visible' : ''}`}
            >
      ...
      {/* 技术支持 */}
      <div className={`tech-support fade-in-section ${isVisible['support'] || false ? 'visible' : ''}`} id="support">
        <div className="container">
          <h2>技术支持</h2>
      ...
      {/* 联系我们 */}
      <div className={`contact-section fade-in-section ${isVisible['contact'] || false ? 'visible' : ''}`} id="contact">
        <div className="container">
          <h2>联系我们</h2>
          ...
          <div className="footer-content">
            ...
            <div className="footer-column">
              ...
              <ul className="footer-links">
                <li><a href="/products#voice-remote">语音遥控器</a></li>
                <li><a href="/products#voice-fan">语音风扇</a></li>
                <li><a href="/products#voice-panel">语音面板</a></li>
                <li><a href="/products#smart-microphone">智能拾音器</a></li>
                <li><a href="/products#voice-agent">语音智能体</a></li>
              </ul>
            </div>
            <div className="footer-column">
              <h4>关于我们</h4>
